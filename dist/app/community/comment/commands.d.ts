...
export type PostCommentProfileResponseCommand = Pick<PostComment, 'id' | 'content' | 'post' | 'createdAt' | 'updatedAt'> & {
...
export type PostCommentUpdateRequestCommand = Partial<PostCommentCreateRequestCommand>;
